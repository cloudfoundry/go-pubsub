...
func (s testStructTrav) Traverse(data interface{}, currentPath []string) pubsub.Paths {
	return s._a(data, currentPath)
}

func (s testStructTrav) done(data interface{}, currentPath []string) pubsub.Paths {
	return pubsub.PathsFunc(func(idx int) (path string, nextTraverser pubsub.TreeTraverser, ok bool) {
		return "", nil, false
	})
}

func (s testStructTrav) _a(data interface{}, currentPath []string) pubsub.Paths {
...
func (s testStructTrav) _b(data interface{}, currentPath []string) pubsub.Paths {
